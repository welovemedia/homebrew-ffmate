cask "ffmate" do
  ...
  on_intel do
    ...
    url "https://github.com/welovemedia/ffmate/releases/download/#{version}/ffmate-darwin-amd64.tar.gz"
  end

  on_arm do
    sha256 "62e6ecc77df199ccad4aa7fb5dd1934fdc4e03eee729903479e1c5c71e1e696f"
    url "https://github.com/welovemedia/ffmate/releases/download/#{version}/ffmate-darwin-arm64.tar.gz"
  end
